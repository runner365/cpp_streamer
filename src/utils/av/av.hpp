...
#define METADATA_TYPE_ONTMETADATA   0
#define METADATA_TYPE_ONTEXTDATA    1
#define METADATA_TYPE_ONCAPTION     2
#define METADATA_TYPE_ONCAPTIONINFO 3
#define METADATA_TYPE_UNKNOWN       9

#define ASC_TYPE_AAC_MAIN 1
#define ASC_TYPE_AAC_LC   2
#define ASC_TYPE_AAC_SSR  3
#define ASC_TYPE_AAC_LTP  4
#define ASC_TYPE_AAC_HE   5
#define ASC_TYPE_AAC_HEv2 29

#define AAC_ADTS_TYPE_MAIN    1
#define AAC_ADTS_TYPE_LC      2
#define AAC_ADTS_TYPE_SSR     3
#define AAC_ADTS_TYPE_RESERVE 4
